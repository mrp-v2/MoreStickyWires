...
public class StickyAdjustedRedstoneWireBlock extends AdjustedRedstoneWireBlock implements IWaterLoggable
{
    public static final BooleanProperty WATERLOGGED = BlockStateProperties.WATERLOGGED;

    public StickyAdjustedRedstoneWireBlock(float hueChange)
    {
        super(hueChange);
    ...
    public void onReplaced(BlockState state, World worldIn, BlockPos pos, BlockState newState, boolean isMoving)
    {
        if (!isMoving && !state.isIn(newState.getBlock()))
        {
            ...
            if (!worldIn.isRemote)
            {
                ...
                this.updatePower(worldIn, pos, newState.isIn(this) ? newState : state);
